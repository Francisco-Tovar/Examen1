...
{
    public class ConsultaBMapper : EntityMapper, ISqlStatements, IObjectMapper
    {
        ...
        {
            var operation = new SqlOperation { ProcedureName = "CONSULTA_B_PR" };
            return operation;
        }
